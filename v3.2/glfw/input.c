...
void glfwPreeditCB(GLFWwindow* window, int textLength, unsigned int* text, int blockLength, int* blocks, int focusedBlock) {
	goPreeditCB(window, textLength, text, blockLength, blocks, focusedBlock);
}

void glfwIMEStatusCB(GLFWwindow* window) {
	goIMEStatusCB(window);
}
...
void glfwSetPreeditCallbackCB(GLFWwindow *window) {
	glfwSetPreeditCallback(window, glfwPreeditCB);
}

void glfwSetIMEStatusCallbackCB(GLFWwindow *window) {
	glfwSetIMEStatusCallback(window, glfwIMEStatusCB);
}
